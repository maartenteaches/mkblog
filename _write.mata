...
void mkblog::write_header()
{
    ...
    if (settings.author != "") fput(fh_main, `"<meta name="author" content=""' + settings.author + `"">"')
    if (settings.keywords != "") fput(fh_main, `"<meta name="keywords" content=""' + settings.keywords + `"">"')
...
void mkblog::log2html()
{
    ...
    fput(fh_clog, `"<div  class="w3-row"> <div class="w3-col w3-container m1"></div> <div class="w3-col m10"> "')
